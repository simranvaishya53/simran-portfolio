...
const About = ({ aboutData, name }: Props) => {
    ...
    return (
        <SectionWrapper id="about" className="pt-0 pb-10 md:pt-8 bg-gradient-to-b from-white to-gray-100/20 dark:from-grey-900 dark:to-grey-900">

            <h2 className="text-4xl text-center">About Me</h2>

            <div className="w-full lg:w-11/12 2xl:w-4/5 mt-0 md:mt-10 mx-auto flex flex-col md:gap-4 lg:flex-row justify-between items-center">
                ...
                <div className="flex-1 text-left mx-4 mt-4 md:mt-0 md:mx-0 md:p-6">
                    <div className="flex flex-col gap-2.5">
                        ...
                        <div className="flex items-center gap-4 md:mt-4 mb-12 md:mb-6">
